...
import 'package:piper_phonemizer_plugin/utils/unzip_espeak_data.dart';

class PiperPhonemizerPlugin {
  /// Singleton instance
  static PiperPhonemizerPlugin? _instance;

  factory PiperPhonemizerPlugin() {
    return _instance ??= PiperPhonemizerPlugin._internal();
  }

  late final DynamicLibrary _lib;

  PiperPhonemizerPlugin._internal() {
    _lib = _openLibrary();
  }
  ...
  Future<String?> getPlatformVersion() {
    return PiperPhonemizerPluginPlatform.instance.getPlatformVersion();
  }
}
