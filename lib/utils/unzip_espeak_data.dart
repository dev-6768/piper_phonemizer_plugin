...
Future<String> unzipEspeakData() async {
  ...
  final targetDir = Directory('${appDocDir.path}/piper_phonemizer_plugin/espeak-ng-data');
  ...
  final byteData = await rootBundle.load('packages/piper_phonemizer_plugin/assets/espeak-ng-data.zip');
