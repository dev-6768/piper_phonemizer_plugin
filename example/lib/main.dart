...
void tester() async {
  final piperPhonemizer = PiperPhonemizerPlugin();
...
class _MyAppState extends State<MyApp> {
  ...
  final _piperPhonemizerPlugin = PiperPhonemizerPlugin();
...
class _PhonemeWidgetState extends State<PhonemeWidget> {
  ...
  bool _loading = false;
  PiperPhonemizerPlugin piperPhonemizer = PiperPhonemizerPlugin();
